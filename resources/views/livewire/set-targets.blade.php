    ...
    <table class="table-auto border-collapse w-full">
        <thead>
            <tr class="rounded-lg text-sm font-medium text-gray-700 text-left">
                <th class="px-3 py-2 bg-gray-200">PAPER</th>
                <th class="px-3 py-2 bg-gray-200">TARGET MARK</th>
                <th class="px-3 py-2 bg-gray-200">ACTUAL MARK</th>
                <th class="px-3 py-2 bg-gray-200">DEVIATION</th>
            </tr>
        </thead>
        <tbody class="text-sm font-normal text-gray-700">
            <tr class="hover:bg-gray-100 border-b border-gray-200 py-5">
                <td class="px-3 py-4">Alice</td>
                <td class="px-3 py-4">alice@example.com</td>
                <td class="px-3 py-4">1234567890</td>
                <td class="px-3 py-4">Alice</td>


            </tr>
            <tr class="hover:bg-gray-100 border-b border-gray-200">
                <td class="px-3 py-4">Bob</td>
                <td class="px-3 py-4"> martin@gmail.com</td>
                <td class="px-3 py-4">1234567890</td>
                <td class="px-3 py-4">Bob</td>
            </tr>
